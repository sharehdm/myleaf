...
* Multi-core support. Leaf utilize its modules and [leaf/go](https://github.com/sharehdm/myleaf/tree/master/go) to make use of CPU resouces at maximum while avoiding varieties of side effects may be caused.
...
A game server implemented with Leaf may include many modules (e.g. [LeafServer](https://github.com/sharehdm/myleafserver)) which all share below traits:

* Each module runs inside a separate goroutine
* Modules communicate with one another via a light weight RPC channel([leaf/chanrpc](https://github.com/sharehdm/myleaf/tree/master/chanrpc))
...
[LeafServer](https://github.com/sharehdm/myleafserver) is a game server developped with Leaf. Let's start with it.

Download the source code of LeafServer：

```
git clone https://github.com/sharehdm/myleafserver
```

Download and install leafserver to GOPATH:

```
go get github.com/sharehdm/myleaf
```
...
import (
    "github.com/sharehdm/myleaf/network/json"
)
...
More references are at [leaf/go](https://github.com/sharehdm/myleaf/blob/master/go)。
...
More references are at [leaf/timer](https://github.com/sharehdm/myleaf/blob/master/timer)。
...
More references are at Wiki [https://github.com/sharehdm/myleaf/wiki](https://github.com/sharehdm/myleaf/wiki)
